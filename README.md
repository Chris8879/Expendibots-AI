...
This project is an attempt to construct an AI that can play the game of Expendibots to a reasonable level, utilising machine learning to an evaluation function coupled with a search over the possible moves that the AI can make.
